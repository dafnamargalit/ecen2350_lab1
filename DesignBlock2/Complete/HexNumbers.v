...
//=======================================================
    ...
    begin
        case (NUM)
            ...
            4'b1001: out <= 8'b11111000;//-7
            4'b1010: out <= 8'b10000010;//-6
            4'b1011: out <= 8'b10010010;//-5
            4'b1100: out <= 8'b10011001;//-4
            4'b1101: out <= 8'b10110000;//-3
            4'b1110: out <= 8'b10100100;//-2
            4'b1111: out <= 8'b11111001;//-1
